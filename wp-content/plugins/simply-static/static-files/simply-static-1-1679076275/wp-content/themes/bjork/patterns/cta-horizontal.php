...
<div class="wp-block-group alignwide has-background-color has-primary-background-color has-text-color has-background" style="border-radius:8px">
	...
	<div class="wp-block-columns is-style-default">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<div class="wp-block-buttons">
				...
				<div class="wp-block-button is-style-fill"><a class="wp-block-button__link has-foreground-background-color has-background">Send us an
						email</a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
